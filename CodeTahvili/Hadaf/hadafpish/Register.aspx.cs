...
namespace hadafpish
{
    public partial class Register : System.Web.UI.Page
    {
                            ...
                            case "7":
                                {
                                    ...
                                    //  Label2.Text = Session["reshte"].ToString();
                                    Label1.Text = Session["stdid"].ToString();
                                    lblreshte.Text = "کاردانی ناپیوسته کنترل  ";
                                }
                                break;
                            case "8":
                                {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            enter currentUser = ar.FindByUserName(Int64.Parse(Label1.Text));
                ...
                //{
                    ...
                    if ((sum >= 12) && (sum <= 20))
                    {
                        ...
                        foreach (GridViewRow gvr in GridView1.Rows)
                        {
                            if ((gvr.FindControl("CheckBox1") as CheckBox).Checked == true)
                            {
                              ...
                              //  string reshte=
                                    ...
                                    newAccount.stdid = Int64.Parse(Label1.Text);
                        ...
                        if (succsesfulsave == "ok")
                        {
                            ...
                            enter user = ur.FindByUserName(Int64.Parse(Label1.Text));
                            ...
                            newstd.stdid = Int64.Parse(Label1.Text);
