<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="adminlogin.aspx.cs" Inherits="hadafpish.Dashboard.adminlogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style=" width:500px;  margin-left:auto;margin-right:auto">
        <table style="border: 1px groove #000000; width:500px">
                <tr>
                    <td colspan="2" align="center" style="border: 1px groove #5D9FE1; background-color: #4A94DD; font-family: 'B Zar'; font-size: 26px; color: #FFFFFF;">
                        صفحه مدیریت<br />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="auto-style5" dir="rtl">
                       <asp:Label ID="lblusername" runat="server" Text="نام کاربری" CssClass="font_custom14"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style7" dir="rtl">
                        ...
                        <asp:Label ID="Label1" runat="server" Text="رمز عبور" CssClass="font_custom14"></asp:Label>
                    </td>
                </tr>
