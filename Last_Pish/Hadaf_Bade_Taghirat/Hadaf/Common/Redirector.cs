  ...
  public  class Redirector
    {
        ...
        {
           COMNP,ok,StdUnit,register,adminsearch,adminpage,stdsearch,insertstd,studentunit,notregister
        ...
        public static void Goto(PageName pageName)
        {
            switch (pageName)
            {
                ...
                case PageName.notregister:
                    { HttpContext.Current.Response.Redirect("~/notregister"); break; }
            }
        }
    }
}
