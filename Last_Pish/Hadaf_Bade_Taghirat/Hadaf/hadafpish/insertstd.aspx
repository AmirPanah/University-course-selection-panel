<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="insertstd.aspx.cs" Inherits="hadafpish.insertstd" %>
        ...
        <table style="border: 1px groove #000000; width:500px">
                ...
                <tr>
                    ...
                    <td class="auto-style7" dir="rtl">
                        ...
                        <asp:Label ID="Label1" runat="server" Text="شماره ملی" CssClass="font_custom14"></asp:Label>
                    </td>
                </tr>
